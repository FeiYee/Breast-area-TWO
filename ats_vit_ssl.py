...
from shape_metric import EMDLoss
...
labeled_train_data = datasets.ImageFolder('labelled_training_dataset/', transform=train_transforms)
unlabeled_train_data_1 = datasets.ImageFolder('unlabelled_training_dataset_1/', transform=train_transforms)
unlabeled_train_data_2 = datasets.ImageFolder('unlabelled_training_dataset_2/', transform=train_transforms)
test_data = datasets.ImageFolder('new_data/training_dataset/', transform=test_transforms)
...
batch_size = 64
labelled_train_loader = torch.utils.data.DataLoader(labeled_train_data, batch_size=batch_size, shuffle=True)
test_loader = torch.utils.data.DataLoader(test_data, batch_size=batch_size, shuffle=True)
unlabelled_train_loader_1 = torch.utils.data.DataLoader(unlabeled_train_data_1, batch_size=batch_size, shuffle=True)
unlabelled_train_loader_2 = torch.utils.data.DataLoader(unlabeled_train_data_2, batch_size=batch_size, shuffle=True)
...
for epoch in range(epochs):
    ...
    for (data, label), (in_1, _), (in_2, _) in zip(labelled_train_loader, unlabelled_train_loader_1, unlabelled_train_loader_2):
        data = data.to(device)
